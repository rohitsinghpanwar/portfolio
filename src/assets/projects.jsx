          ...
          <div className="flex gap-5 lg:gap-10 ">
            <div className="flex lg:flex-row flex-col  gap-10  ">
              ...
              <div className="flex flex-col  w-[8.5rem]  lg:h-80 lg:w-64 relative items-center  transition-all ease-in-out duration-700 hover:scale-110  ">
                ...
                <div className="absolute w-[90%]  lg:w-5/6 bg-white items-center flex flex-col rounded-md -bottom-6 lg:-bottom-2 drop-shadow-xl text-sm text-center lg:text-lg bg-opacity-95">
                  <h1>Rock Paper Scissor Game</h1>
                  <Link to={"https://paperscissorgame.netlify.app"} className=" underline underline-offset-2 text-red-600 pb-1 ">Check it now</Link>
                </div></div>
      <div className="flex flex-col w-[8.5rem]  lg:h-80 lg:w-64 relative items-center  transition-all ease-in-out duration-700   hover:scale-110">
              <img src={rupee} alt="" className="h-full rounded-xl  " />
              <div className="absolute w-[90%] lg:w-5/6 bg-white items-center flex flex-col rounded-md -bottom-6 lg:-bottom-2 drop-shadow-xl text-sm lg:text-lg text-center bg-opacity-95">
                <h1> Currency Converter </h1>
                <Link to={"https://rupeecon.netlify.app"} className=" underline underline-offset-2 text-red-600 pb-1 ">Check it now</Link>
              </div>
