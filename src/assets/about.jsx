...
export default function About() {
  return (
    <>
      <div className="  flex flex-col gap-5 pt-3 items-center bg-gradient-to-l from-blue-300 to-red-300">
        <div className=" border-4 border-double border-black rounded-xl flex flex-col  p-3 gap-5 items-center lg:w-[70%] backdrop-blur-xl bg-white/30  ">
          <img src={rohit} alt="" className="h-40 w-40 lg:h-52 lg:w-52 rounded-full border-4  border-black  object-cover " />
          <h1 className="italic text-lg font-semibold lg:text-center ">Hi, I’m Rohit!<br />
            I’m a passionate programmer and web developer, currently pursuing my B.TECH(C.S.E) at Global Institute of Technology and Management(MDU University). I’m particularly fond of React.js and Java, and I love creating interactive web applications that captivate users. <br />
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="list-none  flex-wrap gap-3 flex justify-evenly lg:flex-row lg:h-16 lg:gap-10">       <div className="group relative">
            <li className="border-4 border-double border-black lg:p-3 text-xl font-bold rounded-xl h-full text-center p-1"><code className="z-10 relative transition-all ease-linear  duration-500 group-hover:text-white">DSA</code></li>
            ...
            <div className="group relative">
              <li className="border-4 border-double border-black   lg:p-3 text-xl font-bold rounded-xl h-full text-center p-1"><code className="z-10 relative transition-all ease-linear  duration-500 group-hover:text-white">C++</code></li>
              <div className="absolute bg-black top-0 w-full h-0    rounded-xl border-4 border-double transition-all ease-in-out  duration-500 invisible text-xl font-bold group-hover:w-full group-hover:h-full group-hover:visible"></div>
            </div>

            <div className="group relative">
              <li className="border-4 border-double border-black  lg:p-3 text-xl font-bold rounded-xl h-full text-center p-1"><code className="z-10 relative transition-all ease-linear  duration-500 group-hover:text-white">Java</code></li>
            ...
            <div className="group relative">
              <li className="border-4 border-double border-black  lg:p-3 text-xl   rounded-xl h-full text-center p-1"><code className="z-10 relative font-bold transition-all ease-linear  duration-500 group-hover:text-white ">Python</code></li>
              <div className="absolute bg-black  top-0 w-full h-0    rounded-xl border-4 border-double transition-all ease-in-out  duration-500 invisible text-xl font-bold group-hover:w-full group-hover:h-full group-hover:visible"></div>
            </div>
            <div className="group relative ">
        ...
        <div>
          <div className="bg-black flex flex-col items-center rounded-t-xl lg:pb-0 pb-8 w-screen gap-3  ">
     ...
     "><img src={cv} alt="" className="w-10  lg:w-16  transition-all ease-linear duration-300  hover:scale-110  hover:border-4 hover:rounded-xl hover:border-white" /></a>
              ...
              <Link to={"https://www.linkedin.com/in/rohit-singh-panwar-4610ba308?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"}><img src={linked} alt="" className=" w-10 lg:w-16 transition-all ease-linear duration-300  hover:scale-110  hover:border-4 hover:rounded-xl hover:border-white" /></Link>

              <div className="group relative ">
                <img src={mail} alt="" className="w-10 lg:w-20 relative top-1  transition-all ease-in-out duration-500  lg:group-hover:scale-50 lg:group-hover:opacity-5 " />
